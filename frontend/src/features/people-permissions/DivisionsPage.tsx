  ...
  return (
    <>
      ...
      <div id="drw" style={{ height: "auto", top: "26%", bottom: "auto", borderRadius: "8px 0 0 8px" }}>
        <div className="dh">
          <h2>{"id" in draft ? "Edit division" : "Add division"}</h2>
        ...
        <div className="db">
          ...
          {!isHome && onDelete && (
            <div className="fld" style={{ marginTop: 14 }}>
              <LegacyBtn secondary onClick={onDelete}>Delete division</LegacyBtn>
            </div>
          )}
        </div>
        <div className="df">
          <LegacyBtn secondary onClick={onClose} disabled={saving}>Cancel</LegacyBtn>
          <LegacyBtn onClick={() => onSave(draft)} disabled={saving || !draft.name}>
